...
//anuncio
require"includes-acoes/anuncio/suprimentos-editar.php";
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
...
<section class="module property-submit">
  <div class="container">
    ...
    <form class="multi-page-form" method="post" name="anunciosupri" id="anunciosupri" action="editar-anuncio-suprimentos-enviado?area=<?php echo $area?>" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="form-block">
                  ...
                  <input class="border <?php if($dadosla['tipo']=="0"){?>required<?php }?>" type="text" name="preco" id="preco" value="<?php echo number_format($lineanuncio['preco'], 2, ',','.')?>"/>
                </div>
              </div>        
            </div>
...
Marca, Material, Tecnologia e Medidas são importantes.</p>
      ...
      <div class="multi-page-form-content <?php if(isset($_SESSION['images'])){?>active<?php }?>">
        ...
        <span class="button button-icon small right form-next" onclick="javascript:anunciosupri.submit()"><i class="fa fa-angle-right"></i> Enviar</span>
