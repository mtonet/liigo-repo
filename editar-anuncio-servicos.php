...
//anuncio
require"includes-acoes/anuncio/servicos-editar.php";
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
...
<section class="module property-submit">
  <div class="container">
    ...
    <form class="multi-page-form" method="post" name="anuncioserv" id="anuncioserv" action="editar-anuncio-servicos-enviado?area=<?php echo $area?>" enctype="multipart/form-data">
            ...
            <td>
             ...
             <div class="form-block border">
                  <label>Tipo de serviço*</label>
                    ...
                    <option value="<?php echo $lineserv['id_cod']?>" <?php if($lineanuncio['id_subcategoria']==$lineserv['id_cod']){?>selected<?php }?>><?php echo $lineserv['nome']?></option>
                    <?php }?>
                  </select>
                </div>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="form-block">
                  ...
                  <input class="border <?php if($dadosla['tipo']=="0"){?>required<?php }?>" type="text" name="preco" value="<?php echo number_format($lineanuncio['preco'], 2, ',','.')?>"/>
                </div>
              </div>        
            </div>
