...
?>
<ul>
<?php if($anterior>=0){?><li><a href="?equipamento=<?php echo $equipamento?>&tecnologia=<?php echo $tecnologia?>&marca=<?php echo $marca?>&cabeca=<?php echo $cabeca?>&acao=<?php echo $acao?>&pagina=<?php echo $anterior?>" class="button small grey"><i class="fa fa-angle-left"></i></a></li><?php }?>
<?php
for($i=1; $i <= $totalPag; $i++){
$indice ="pagina=".$i."";
?>

<li <?php if($i==$pag){?> class="current" <?php }?>><a href="?equipamento=<?php echo $equipamento?>&tecnologia=<?php echo $tecnologia?>&marca=<?php echo $marca?>&cabeca=<?php echo $cabeca?>&acao=<?php echo $acao?>&<?php echo $indice?>" class="button small grey"><?php echo $i?></a></li>
<?php
}
?>  

<?php if($totalPag>=$proximo){?><li><a href="?equipamento=<?php echo $equipamento?>&tecnologia=<?php echo $tecnologia?>&marca=<?php echo $marca?>&cabeca=<?php echo $cabeca?>&acao=<?php echo $acao?>&pagina=<?php echo $proximo?>" class="button small grey"><i class="fa fa-angle-right"></i></a></li><?php }?>
