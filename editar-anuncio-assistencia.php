...
//anuncio
require"includes-acoes/anuncio/assistencia-editar.php";
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
...
<section class="module property-submit">
  <div class="container">
    ...
    <form class="multi-page-form" method="post" name="anuncioassist" id="anuncioassist" action="editar-anuncio-assistencia-enviado?area=<?php echo $area?>" enctype="multipart/form-data">
