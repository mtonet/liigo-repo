...
//anuncio
require"includes-acoes/anuncio/transportadoras-editar-enviar.php";
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
      ...
      <div class="multi-page-form-content active">
        ...
        <table class="property-submit-title">
          <tr>
            ...
            <td>
              <h4>Anúncio editado com sucesso!</h4>
              <p>Recebemos a alteração do seu anúncio e o mesmo irá passar por uma revisão e em breve será publicado novamente.</p>
            </td>
          </tr>
        </table>
