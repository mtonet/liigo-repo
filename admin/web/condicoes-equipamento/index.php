...
//condicoes-equipamento
require"../../includes-acoes/condicoes-equipamento/lista.php";
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Condições de equipamento </h3>
              </div>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="../condicoes-equipamento/cadastrar.php"><h6>Cadastrar</h6></a>
                          </li>
                        </ul>
                      </li>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="../condicoes-equipamento/editar.php?area=<?php echo $line['id_cod']?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <p>Deseja realmente excluir a categoria <b><?php echo $line['nome']?></b>?</p>
                        </div>
