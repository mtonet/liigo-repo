...
//categoria
require"../../includes-acoes/categoria/lista.php";
?>
<!DOCTYPE html>
<html lang="pt-br">
  <head>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="../categorias/cadastrar.php"><h6>Cadastrar</h6></a>
                          </li>
                        </ul>
                      </li>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="../categorias/editar.php?area=<?php echo $line['id_cod']?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Editar </a>
