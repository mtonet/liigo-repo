...
$message="<table width='600' border='0' align='center' cellpadding='0' cellspacing='0'>
  ...
  <tr>
    <td align='center' style='font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000;'>Olá <b>".$lineuser['nome']."</b>.</td>
  </tr>
  <tr>
    <td align='center'>&nbsp;</td>
  </tr>
  <tr>
    <td align='center' style='font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000;'>Você recebeu uma nova mensagem de <b>".$lineuserv['nome']."</b>.<br>
      <br>
...
//envio do email
mail($lineuser['email'], $subject, $message, $headers);
