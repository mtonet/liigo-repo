...
//dados
$listaanuncio="SELECT id_cod,id_user,titulo,id_subcategoria,subcategoria,descricao,avatar from tbl_anuncio WHERE id_cod='".$area."' AND id_user='".$lineuser['id_cod']."'";
